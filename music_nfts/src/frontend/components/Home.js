...
const Home = ({ contract }) => {
  ...
  <div className='header'>
    <div>
  <blockquote>
    Spotify & Nft is a blockchain based music app and it's will provide the high quality music and provide a secure transaction about music
   <i>~Vu</i>
</blockquote>
<blockquote lang="fr">
...
<blockquote>
The customer is very important, the customer will be followed by the customer. Proin lacinia euismod employee. Tomorrow it's time for the sauce, it's an element of my taste. Even my ligula, the real life of the hospital, just like a quiver of life. Aeneas is a great turpis, and we need someone to drive it, so that we can promote it. Now the ultricies need a lion unless they expect ultricies. Tomorrow is as ugly as it gets. It takes a lot of homework, and the author invests time in it. Some are pure and pure, but it is good for one's property, for one needs ends. Some medical career in the port port of the valley.
